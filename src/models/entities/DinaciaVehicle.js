...
export const BaseDinaciaVehicle = types
	...
	.model('BaseDinaciaVehicle', {
		...
		empty_weight: types.maybeNull(types.optional(types.number,0)),
		max_weight: types.maybeNull(types.optional(types.number,0)),
		...
		longitude: types.maybeNull(types.optional(types.number,0)),
		height: types.maybeNull(types.optional(types.number,0)),
		color: types.maybeNull(types.string),
		max_speed: types.maybeNull(types.optional(types.number,0)),
		cruise_speed: types.maybeNull(types.optional(types.number,0)),
		landing_speed: types.maybeNull(types.optional(types.number,0)),
