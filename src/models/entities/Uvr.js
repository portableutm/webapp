...
export const Uvr = types
	.model({
		...
		permitted_uas: types.optional(types.enumeration('UvrPermittedUAS', ['NOT_SET', 'PUBLIC_SAFETY', 'SECURITY', 'NEWS_GATHERING', 'VLOS', 'SUPPORT_LEVEL', 'PART_107', 'PART_101E', 'PART_107X', 'RADIO_LINE_OF_SIGHT']), 'NOT_SET')
	});
/*
